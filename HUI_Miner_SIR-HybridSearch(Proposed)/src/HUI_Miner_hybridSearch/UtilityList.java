...
public class UtilityList {
	 ...
	 long sumRutils = 0;// the sum of remaining utilities
         long minIutils=999999999;//minimum iutil value of itemset from all transactions
         long minRutils=999999999;//minimum rutil value of itemset from all transactions
	...
	public void addElement(Element element){
		...
		sumRutils += element.rutils;
                if(minIutils>=element.iutils)
                {
                    minIutils=element.iutils;
                }
                if(minRutils>=element.rutils)
                {
                    minRutils=element.rutils;
                }
