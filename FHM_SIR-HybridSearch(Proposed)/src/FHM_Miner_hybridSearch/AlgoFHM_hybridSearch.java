package FHM_Miner_hybridSearch;
 ...
 */
public class AlgoFHM_hybridSearch {
	...
	Map<Integer, Long> mapItemToTWU;
        ...
        //Map to remember the support count of each item
			...
			while ((thisLine = myInput.readLine()) != null) {
				...
				for(int i=0; i <items.length; i++){
					...
					mapItemToTWU.put(item, twu);
                                        ...
                                        Integer Sup = mapItemToSupport.get(item);
					// add the utility of the item in the current transaction to its twu
					Sup = (Sup == null)? 
							1 : Sup+1;
					mapItemToSupport.put(item, Sup);
...
//		}
        ...
        Element ex;
        Element ey;
        if(xsize>ysize && SIR==0){
            SIR=1;
        }

//        int value=min(xsize,ysize);
...
// return the utility list of pXY.
	...
	public void printStats() throws IOException {
		System.out.println("=============  FHM ALGORITHM -Proposed - STATS =============");
